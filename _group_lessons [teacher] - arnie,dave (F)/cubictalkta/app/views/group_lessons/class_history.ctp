...
<div id = "wrapper"  class = "div-container">
	...
	<ul class = "nav nav-tabs">
		...
		<li class="active" id = "active"><a href="#"><h5><strong>Class History</strong></h5></a></li>
	</ul>
...
<script>
	...
	function popup_details(groupLessonId){
		window.open("<?=c_path()?>/group_lessons/window_popup_details_2/"+groupLessonId, "", "width=350,height=200");
	}
