		...
		<tr>
			...
			<td width="762" valign="top" colspan="2">
				...
				<tr>
					...
					<td><a href = "<?php echo c_path().'/language_redirect/change_lang/ko/'.$controller.'/'.$action ?>"><img src="<?=b_path()?>/image/topmenu03.gif" border="0" alt="한국어"></a></td>
					<td><a href = "<?php echo c_path().'/language_redirect/change_lang/en/'.$controller.'/'.$action ?>"><img src="<?=b_path()?>/image/topmenu04.gif" border="0" alt="일본어"></a></td>
					<td><a href = "#">mark</a></td>
					</tr>
