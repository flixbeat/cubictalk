<?php echo $language[$session->read('lang')]['fluency']; ?>

<?php #echo $language[$session->read('lang')]['grammar']; ?>
<?php echo c_path();?>
...
<!--
<?php #include('language_dropdown.ctp');?>
...
<script>
	...
	$('#tbLang').val( $('lang_dropdown').val() );
	$('#lang_dropdown').val("<?=$session->read('lang')?>");
</script>
-->
