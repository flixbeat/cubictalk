...
<div class="div-container">
	...
	<div style="border:1px solid #ccc;width:202px;">
		<table class="" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
			...
			<tr>
				<td class="text-left">
					<a href="<?php echo $cubictalkko_path;?>/compositions/composition/" style="margin-left:1.5em;">
						<img src="<?php echo $cubictalkko_path;?>/image/icon/compositions-icon.png" border="0" alt="작문" title="Compositions">
					</a>
				</td>
				<td class="text-right"><a href="<?php echo $cubictalkko_path;?>/group_lessons/my_reservations/" style="margin-right:1.5em;">
					<img src="<?php echo $cubictalkko_path;?>/image/icon/friends-icon.png" border="0" alt="친구소개" title="Introduce friends"></a></td>
